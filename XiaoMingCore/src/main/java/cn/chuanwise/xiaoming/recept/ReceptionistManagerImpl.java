...
public class ReceptionistManagerImpl
    ...
    public void onGroupMessageEvent(GroupMessageEvent event) {
        if (!xiaomingBot.getConfiguration().isEnableGroupInteractors()) {
            return;
        }
    ...
    public void onPrivateMessageEvent(FriendMessageEvent event) {
        if (!xiaomingBot.getConfiguration().isEnablePrivateInteractors()) {
            return;
        }
    ...
    public void onMemberMessageEvent(GroupTempMessageEvent event) {
        if (!xiaomingBot.getConfiguration().isEnableMemberInteractors()) {
            return;
        }
