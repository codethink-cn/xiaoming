...
public final class Permission
    ...
    protected interface Element extends Cloneable {
        @Override
        String toString();
    }
    ...
    protected static class PlainTextElement implements Element {
        ...
        @Override
        public PlainTextElement clone() {
            return new PlainTextElement(text, brace);
        }
    }
    ...
    protected static class PatternElement implements Element {
        ...
        public PatternElement clone() {
            return new PatternElement(pattern);
        }
    }
    ...
    public static Permission reversed(Permission permission) {
        final Permission compile = compile(permission.toString());
        return new Permission(!permission.granted, compile.elements);
    }
