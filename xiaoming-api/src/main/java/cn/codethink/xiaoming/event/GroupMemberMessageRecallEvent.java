 ...
 */
@Data
public class GroupMemberMessageRecallEvent
    extends AbstractEvent
    implements MemberMessageRecallEvent {
    ...
    public GroupMemberMessageRecallEvent(GroupMember member, CompoundMessage message, long timestamp) {
