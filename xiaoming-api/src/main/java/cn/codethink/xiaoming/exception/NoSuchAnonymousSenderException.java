...
public class NoSuchAnonymousSenderException
    ...
    public NoSuchAnonymousSenderException(Bot bot, Code code) {
        super("can not find the anonymous sender with code: " + code);
