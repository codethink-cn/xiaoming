 ...
 * @author Chuanwise
 */
public class MiraiFromGroupMessageSource
    extends AbstractMiraiOnlineMessageSource
    implements FromGroupMessageSource {
    
    public MiraiFromGroupMessageSource(OnlineMessageSource.Incoming.FromGroup miraiMessageSource,
                                       GroupSender sender,
                                       Map<Property<?>, Object> properties) {
        
        super(miraiMessageSource, sender, sender.getMass(), properties);
    }
