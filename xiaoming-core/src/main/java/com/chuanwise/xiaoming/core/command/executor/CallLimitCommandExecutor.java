...
public class CallLimitCommandExecutor extends CommandExecutorImpl {
    ...
    public CallLimitCommandExecutor(XiaomingBot xiaomingBot) {
        setXiaomingBot(xiaomingBot);
        callLimitManager = getXiaomingBot().getUserCallLimitManager();
        config = callLimitManager.getGroupCallLimiter().getConfig();
    }

    @Command(CommandWords.GROUP_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX)
    ...
    @Command(CommandWords.GROUP_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (周期|period) {time}")
    ...
    @Command(CommandWords.GROUP_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (上限|top) {time}")
    ...
    @Command(CommandWords.GROUP_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (冷却时间|冷却|cooldown) {time}")
    ...
    @Command(CommandWords.PRIVATE_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX)
    ...
    @Command(CommandWords.PRIVATE_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (周期|period) {time}")
    ...
    @Command(CommandWords.PRIVATE_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (上限|top) {time}")
    ...
    @Command(CommandWords.PRIVATE_REGEX + CALL_REGEX + CommandWords.LIMIT_REGEX + " (冷却时间|冷却|cooldown) {time}")
