 ...
 * @author Chuanwise
 */
public class ResponseGroupInteractor extends InteractorImpl {
    final ResponseGroupManager groupManager;

    public ResponseGroupInteractor(XiaomingBot xiaomingBot) {
    ...
    public void onListGroupTags(GroupXiaomingUser user) {
        ...
        user.sendMessage("{}的所有标记有：{}", group.getAliasAndCode(), CollectionUtility.toString(tags, "、"));
    }
