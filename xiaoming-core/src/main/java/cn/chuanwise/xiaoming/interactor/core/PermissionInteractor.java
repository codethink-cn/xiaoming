...
public class PermissionInteractor extends InteractorImpl {
    ...
    public <T> T parseParameter(XiaomingUser user, Class<T> clazz, String parameterName, String currentValue, Map<String, String> argumentValues, String defaultValue) {
        Object result = super.parseParameter(user, clazz, parameterName, currentValue, argumentValues, defaultValue);
    ...
    public void onNewPermissionGroup(XiaomingUser user,
        ...
        if (Objects.nonNull(group)) {
            ...
            getXiaomingBot().getFileSaver().readySave(permissionManager);
    ...
    public void onListPermissions(XiaomingUser user) {
        ...
        for (Interactor interactor : coreInteractors) {
            for (InteractorMethodInformation methodInformation : interactor.getInteractorMethodInformation()) {
